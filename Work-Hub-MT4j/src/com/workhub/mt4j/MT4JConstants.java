...
public class Constants {
	...
	/*
	 * ID des menus. Pour chacun d'entre eux la taille doit �tre pr�cis�e dans ContextMenu.sizeOf().
	 */
	...
	public static final String CONTEXT_BUTTON_CREATE_TEXT			= "Cr�er un �l�ment texte";
	public static final String CONTEXT_BUTTON_CREATE_IMAGE			= "Cr�er un �l�ment image";
	public static final String CONTEXT_BUTTON_CREATE_LINK			= "Cr�er un �l�ment lien";
	public static final String CONTEXT_BUTTON_CREATE_FILE			= "Cr�er un �l�ment fichier";
	public static final String CONTEXT_BUTTON_VISUALIZE_ELEMENTS	= "Visualiser tous les �l�ments";
	...
	public static final String CONTEXT_BUTTON_SPLIT_GROUP			= "S�parer le groupe";
